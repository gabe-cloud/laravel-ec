...
class ProductController extends Controller
{
    public function index()
    {
        ...
        return Inertia('admin/product/Index', ['products' => $products, 'brands' => $brands, 'categories' => $categories]);
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin.products.index')->with('success', 'Image deleted succesfully');
    }
